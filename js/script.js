...
$(document).ready(function(){
	...
	changeListPrices(workTypePrices, 'a-articles' );
...
function changeListPrices(workTypePrices, workType){
	...
	var priceVal = getCost( workType );

	workType = workType.replace("a-", "");

	var values = priceVal[workType];
	
	for(var i=0; i<planNames.length; i++){

		if( typeof values[planNames[i]] !== 'undefined' )
		{
			var dataPlan = values[planNames[i]];
			var rowsplan = '';
			var words = 'Words';

			$.each(dataPlan, function(index, value) {
			    
			    if( isNaN( value ) == false )
			    {
			    	value = "$"+value;
					value = value.replace('.5', '.50');
			    }

			    rowsplan = rowsplan + ( "<li>"+
							                "<div class='col-xs-7'>"+index.replace("w", "")+" "+words+"</div>"+
							                "<div class='col-xs-5'><strong class='"+index+"'>"+value+"</strong></div>"+
							            "</li>" );
			});

			$("[data-plan-type = "+planNames[i]+"]").hide().html( "<ul>" + rowsplan +"</ul>" ).fadeIn(800);
		}
	}
}
...
var htmlplanlist = "<ul>"+
                        "<li>"+
                            "<div class='col-xs-7'>"+number1+" "+words1+"</div>"+
                            "<div class='col-xs-5'><strong class='"+words1+"'>$"+price1+"</strong></div>"+
                        "</li>"+
                        "<li>"+
                            "<div class='col-xs-7'>"+number2+" "+words2+"</div>"+
                            "<div class='col-xs-5'><strong class='"+words2+"'>$"+price2+"</strong></div>"+
                        "</li>"+
                        "<li>"+
                            "<div class='col-xs-7'>"+number3+" "+words3+"</div>"+
                            "<div class='col-xs-5'><strong class='"+words3+"'>$"+price3+"</strong></div>"+
                        "</li>"+
                        "<li>"+
                            "<div class='col-xs-7'>"+number4+" "+words4+"</div>"+
                            "<div class='col-xs-5'><strong class='"+words4+"'>$"+price4+"</strong></div>"+
                        "</li>"+
                        "<li>"+
                            "<div class='col-xs-7'>"+number5+" "+words5+"</div>"+
                            "<div class='col-xs-5'><strong class='"+words5+"'>$"+price5+"</strong></div>"+
                        "</li>"+
                        "<li>"+
                            "<div class='col-xs-7'>"+number6+" "+words6+"</div>"+
                            "<div class='col-xs-5'><strong class='"+words6+"'>$"+price6+"</strong></div>"+
                        "</li>"+
                        "<li>"+
                            "<div class='col-xs-7'>"+number7+" "+words7+"</div>"+
                            "<div class='col-xs-5'><strong class='"+words7+"'>$"+price7+"</strong></div>"+
                        "</li>"+
                        "<li>"+
                            "<div class='col-xs-7'>"+number8+" "+words8+"</div>"+
                            "<div class='col-xs-5'><strong class='"+words8+"'>$"+price8+"</strong></div>"+
                        "</li>"+
                        "<li>"+
                            "<div class='col-xs-7'>"+number9+" "+words9+"</div>"+
                            "<div class='col-xs-5'><strong class='"+words9+"'>$"+price9+"</strong></div>"+
                        "</li>"+
                    "</ul>";
*/
...
var workTypePrices = {
	'a-articles' : {
		'standard': {
			'w150': {"name": "150 Words", "price": 1.5},
			'w300': {"name": "7000 Words (~20 pages)", "price": 2.75},
			'w400': 4,
			'w500': 5.5,
			'w700': 7.5,
			'w1000': 10.1
